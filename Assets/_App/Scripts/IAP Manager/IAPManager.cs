...
public class IAPKey
{
    public const string PACK1 = "garden_sort.game.pack_in_app.i1";
    public const string PACK2 = "garden_sort.game.pack_in_app.i2";
    public const string PACK3 = "garden_sort.game.pack_in_app.i3";
    public const string PACK4 = "garden_sort.game.pack_in_app.i4";
    public const string PACK5 = "garden_sort.game.pack_in_app.i5";
    public const string PACK6 = "garden_sort.game.pack_in_app.i6";
}
